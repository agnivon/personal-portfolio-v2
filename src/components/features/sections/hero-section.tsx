...
export const HeroSpotlight = ({
  ...
  return (
    <section className="h-screen w-full rounded-md flex flex-col items-center justify-center antialiased relative overflow-hidden snap-always snap-center bg-gradient-to-b from-black from-90% to-transparent">
      <Spotlight />
