...
// Query: *[_type == "project" && hidden != true] | order(createdAt desc) {          _id,           name,          order,          mobile,          "slug": slug.current,          tagline,          "logo": logo.asset->url,        }
...
// Query: *[_type == "project" && slug.current == $slug][0]{          _id,          name,          mobile,          projectUrl,          githubUrl,          "logo": logo.asset->url,          coverImage { alt, "image": asset->url },          screenshots[] { alt, "image": asset->url },          tagline,          description,          technologies,          keywords,        }
...
// Query: *[_type == "project" && hidden != true] | order(createdAt desc){          _id,          name,          order,          mobile,          projectUrl,          githubUrl,          coverImage { alt, "image": asset->url },          screenshots[] { alt, "image": asset->url },          tagline,          "slug": slug.current,          "logo": logo.asset->url,          description,          technologies,        }
